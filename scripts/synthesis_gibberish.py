...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_file", type=str, default=INPUT, help="Input text file path"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default=OUTPUT_DIR,
        help="Output directory for WAV files and JSON",
    )
    parser.add_argument(
        "--voicevox_url", type=str, default=VOICEVOX_URL, help="VOICEVOX server URL"
    )
    parser.add_argument(
        "--voicevox_speaker",
        type=int,
        default=VOICE_VOX_SPEAKER,
