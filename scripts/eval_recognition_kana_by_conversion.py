...
Usage:
  ...
  python eval_recognition_kana_by_conversion.py dataset.json --wav-dir /path/to/wav/files
"""
...
def main():
    ap = argparse.ArgumentParser(description="Kana ASR Evaluation Tool using pyopenjtalk conversion")
    ap.add_argument(
        "json_file", 
