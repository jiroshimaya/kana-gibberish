...
class TestUnigramGeneratorGenerate:
    ...
    def test_最初の文字制約_無効な文字で開始しない(self):
        ...
        for _ in range(100):
            ...
            assert (
                first_char not in invalid_first_chars
            ), f"生成された文字列 '{result}' が無効な文字 '{first_char}' で開始しました"
    ...
    def test_長さ1の場合も制約適用(self):
        ...
        for _ in range(50):
            ...
            assert (
                result not in invalid_first_chars
            ), f"長さ1で生成された文字 '{result}' が無効な文字です"
...
class TestBigramGeneratorGenerate:
    ...
    def test_min_lengthパラメータ_異常系_負の値(self):
        ...
        try:
            ...
            raise AssertionError("負のmin_lengthで例外が発生しませんでした")
    ...
    def test_min_lengthパラメータ_異常系_ゼロ(self):
        ...
        try:
            ...
            raise AssertionError("ゼロのmin_lengthで例外が発生しませんでした")
        except ValueError as e:
            assert "Expected positive integer for min_length" in str(e)
    ...
    def test_min_lengthパラメータ_異常系_max_lengthより大きい(self):
        ...
        try:
            ...
            raise AssertionError("min_length > max_lengthで例外が発生しませんでした")
        except ValueError as e:
